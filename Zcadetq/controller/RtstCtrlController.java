...
public class RtstCtrlController extends DefaultBlockController {


	
	public RtstCtrlController(IFormController parentController, String name) 
	{
	...
	//action methods generated from triggers
		...
		/* Original PL/SQL code code for TRIGGER RTST_CTRL.KEY-CREREC
   ...
   G$_CHECK_FAILURE ;
		...
		*/
		...
		public void rtstCtrl_CreateRecord()
		{
		...
		/* Original PL/SQL code code for TRIGGER RTST_CTRL.KEY-DELREC
		    EXECUTE_TRIGGER( 'INVALID_FUNCTION_MSG' ) ;
   G$_CHECK_FAILURE ;
		*/
		/*
		...
		*/
		...
		public void rtstCtrl_DeleteRecord()
		{
		...
		/* Original PL/SQL code code for TRIGGER RTST_CTRL.KEY-ENTQRY
		    EXECUTE_TRIGGER( 'INVALID_FUNCTION_MSG' ) ;
   G$_CHECK_FAILURE ;
		*/
		/*
		...
		*/
		...
		/* Original PL/SQL code code for TRIGGER RTST_CTRL.KEY-NXTREC
		    EXECUTE_TRIGGER( 'INVALID_FUNCTION_MSG' ) ;
   G$_CHECK_FAILURE ;
		*/
		/*
		...
		*/
		...
		public void rtstCtrl_NextRecord()
		{
		...
		/* Original PL/SQL code code for TRIGGER RTST_CTRL.KEY-NXTSET
		    EXECUTE_TRIGGER( 'INVALID_FUNCTION_MSG' ) ;
   G$_CHECK_FAILURE ;
		*/
		/*
		...
		*/
		...
		public void rtstCtrl_KeyNxtset()
		{
		...
		/* Original PL/SQL code code for TRIGGER RTST_CTRL.KEY-PRVREC
		    EXECUTE_TRIGGER( 'INVALID_FUNCTION_MSG' ) ;
   G$_CHECK_FAILURE ;
		*/
		/*
		...
		*/
		...
		public void rtstCtrl_PreviousRecord()
		{
