...
public class Scrratt1Controller extends DefaultBlockController {


	
	public Scrratt1Controller(IFormController parentController, String name) 
	{
	...
	//action methods generated from triggers
		...
		*/
		...
		@BeforeQuery
		public void scrratt1_BeforeQuery(QueryEvent args)
		{	
				ScbcrseAdapter scbcrseElement = (ScbcrseAdapter)this.getFormModel().getScbcrse().getRowAdapter(true);
				Scrratt1Adapter scbcrseElement1 = (Scrratt1Adapter)this.getFormModel().getScrratt1().getRowAdapter(true);
				...
				scbcrseElement1.setScrrattTermCodeTo(termCode.getValue());
