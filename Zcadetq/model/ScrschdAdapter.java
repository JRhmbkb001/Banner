...
public class ScrschdAdapter extends BaseRowAdapter{
	...
	public void setStvschdDesc(NString value){
		this.setValue("STVSCHD_DESC", value.getValue());
	}


	public NString getStvschdDesc(){
		NString v = new NString((String)this.getValue("STVSCHD_DESC"));
		return v;
	}
