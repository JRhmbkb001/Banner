...
public class GNavBlockController extends DefaultBlockController {
	...
	//action methods generated from triggers
		...
		*/
		...
		@ActionTrigger(action="CALL_ROUTINE", fireInSearch=false)
		...
		*/
		...
		@ActionTrigger(action="INIT_NEXT_SELECTION", fireInSearch=false)
		...
		*/
		...
		@ActionTrigger(action="GLO_INIT_ROUTINE", fireInSearch=false)
  ...
  IF :SYSTEM.FORM_STATUS = 'CHANGED' THEN
    MESSAGE( G$_NLS.Get('GOQOLIB-0010', 'FORM','*ERROR* There are pending form changes; Commit or Rollback.') );
...
END;
		...
		*/
		...
		public void goItem_keyNexItem()
		{
				...
				{
					errorMessage(GNls.Fget(toStr("GOQOLIB-0010"), toStr("FORM"), toStr("*ERROR* There are pending form changes; Commit or Rollback.")));
